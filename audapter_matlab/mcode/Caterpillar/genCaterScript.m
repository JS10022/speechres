...
function caterScript = genCaterScript(stage, nReps, words, varargin)
caterScript			 = struct();
...
caterScript.nReps		= nReps;
caterScript.nTrials 	= 0;
...
%}
	...
	caterScript.nTrials					= caterScript.nTrials + length(oneRep.trialOrder);
end
return