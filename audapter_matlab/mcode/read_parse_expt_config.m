...
items = { {'SUBJECT_ID',	'str'}, ...
        ...
        {'VOWEL_LEN_TARG',	'num'}, ...
        {'VOWEL_LEN_RANGE',	'num'}, ...
        {'STIM_UTTER',		'str_cell'}, ...	% ======== STIM_UTTER ========
        {'SUST_STIM_UTTER', 'str_cell'}, ...	% ======== SUST_STIM_UTTER ========
		{'CATERPILLAR',		'para'}, ...		% ======== Caterpillar Script ========
        {'PRE_REPS',		'num'}, ...
        {'PRACT1_REPS',		'num'}, ...
        {'PRACT2_REPS',		'num'}, ...
		{'CATER_REPS',		'num'}, ...			% ======== Caterpillar Reps ========
        {'SUST_START_REPS', 'num'}, ...
        {'SUST_RAMP_REPS',	'num'}, ...
        {'SUST_STAY_REPS',	'num'}, ...
        {'SUST_END_REPS',	'num'}, ...
		{'SUST_CAT_REPS',	'num'}, ...			% ======== Caterpillar Reps ??? ========
        {'TRIAL_LEN',		'num'}, ...
        {'TRIAL_LEN_MAX',	'num'}, ...
		{'CATER_TRIAL_LEN',	'num'}, ...			% ======== Caterpillar Trial Length ========
		{'CATER_LEN_MAX',	'num'}, ...			% ======== Caterpillar Max Trial Length ========
        {'SAMPLING_RATE',	'num'}, ...
        {'FRAME_SIZE',		'num'}, ...
        {'DOWNSAMP_FACT',	'num'}, ...
...
%}		
    ...
    elseif isequal(item{2}, 'str_cell')						% ======================= str_cell =======================
		str		= getStimStr('str_cell');
		
		str		= strtrim(str);								% Remove leading and trailing white space from string
        idxs	= strfind(str, ' ');						% Find one string within another
        words	= cell(1,0);								% Creates 
